...
chart.Histogram((m.m),methods=c("add.density","add.risk","add.rug","add.qqplot","add.centered"))
chart.Histogram((lv.m),methods=c("add.density","add.risk","add.rug","add.qqplot","add.centered"))
chart.Histogram((e.m),methods=c("add.density","add.risk","add.rug","add.qqplot","add.centered"))
...
# to add idd gaussian Distn with same mean and sd as data
set.seed(123)
